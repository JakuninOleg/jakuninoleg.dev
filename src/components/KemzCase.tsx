...
export async function KemzCase({ locale }: { locale: string }) {
  ...
  return (
    <article className="kemz-case">
      <section className="kemz-hero" aria-labelledby="kemz-title">
        ...
        <div className="shell kemz-hero__inner">
          ...
          <div className="kemz-hero__art">
            <div className="kemz-hero__tablet" aria-label={p("kemz.caption")}><div className="kemz-hero__screen"><Image src="/projects/aokemz-v2.webp" alt={p("kemz.caption")} width={1265} height={712} sizes="(max-width: 900px) 100vw, 60vw" priority unoptimized /></div></div>
      ...
      <section className="shell kemz-details" aria-labelledby="kemz-details-title"><div className="kemz-details__heading"><div><p className="kemz-kicker">04 / {p("kemz.detailsLabel")}</p><h2 id="kemz-details-title">{p("kemz.detailsTitle")}</h2></div><p>{p("kemz.detailsText")}</p></div><div className="kemz-details__grid"><figure className="kemz-details__primary"><Image src="/projects/aokemz-v2.webp" alt={p("kemz.caption")} width={1265} height={712} sizes="(max-width: 800px) 100vw, 60vw" unoptimized /><figcaption>{p("kemz.caption")}</figcaption></figure><figure className="kemz-details__interface"><KemzCatalogPreview locale={locale} /><figcaption>{p("kemz.scope2Title")}</figcaption></figure><figure className="kemz-details__interface"><KemzRequestPreview locale={locale} /><figcaption>{p("kemz.scope3Title")}</figcaption></figure></div></section>
